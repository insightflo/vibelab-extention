...
> **목적**: 31개 스킬(바이브랩 27개 + 우리스킬 4개) 중 현재 상황에 가장 적합한 스킬을 **단 하나만** 추천하는 메타 허브입니다.
>
...
| **`/audit`** | `/audit`, "품질 검사" | 배포 전 종합 감사 (DDD/TestSprite/브라우저) |
...
| `/multi-ai-review` | 머지/배포 전 | Claude+Gemini+GLM 3중 검증 |
