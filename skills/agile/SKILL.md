...
>
> **v1.9.0 업데이트**: 바이브랩스킬과의 역할 분담 명확화, 고유 레이어 기반 워크플로우 강조
...
| **레이어 완료 시** | `/code-review` | 2단계 코드 리뷰 |
| **전체 완료 시** | `/audit` | 품질 감사 |
...
**Last Updated**: 2026-01-27 (v1.9.0 - VibeLab Skill Integration & Layer-based Workflow)
